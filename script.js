...
for (let i = 0; i < dropList.length; i++) {
    ...
    loadFlag(dropList[i]); // Load flag immediately after inserting options
...
window.addEventListener("load", ()=>{
    loadFlag(fromCurrency); // Load flag for fromCurrency
    loadFlag(toCurrency);   // Load flag for toCurrency
    getExchangeRate();
});
